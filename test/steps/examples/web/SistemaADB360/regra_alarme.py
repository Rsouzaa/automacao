...
@step("a new alarm rule will be created")
def test(context):
    # retract management
    ...
    # click on regra alarme
    btn__login = Button(By.XPATH, '//*[@id="menu_0_6"]/ul/li[1]/div/a')
    btn__login.wait_until_clickable()
    btn__login.click()
    ...
    # regra log
    context.driver.find_element(By.CLASS_NAME, 'se_alarm').send_keys("Com Programação Horária")
    context.driver.find_element(By.CLASS_NAME, 'se_alarm').send_keys(Keys.ENTER)

    # regra alarme
    context.driver.find_element(By.CLASS_NAME, 'se_log').send_keys("Com Programação Horária")
    context.driver.find_element(By.CLASS_NAME, 'se_log').send_keys(Keys.ENTER)

    context.driver.find_element(By.CLASS_NAME, 'se_value').send_keys("12")
    context.driver.find_element(By.CLASS_NAME, 'se_value ').send_keys(Keys.ENTER)


@step("Including the information")
def test(context):
    context.driver.find_element(By.CLASS_NAME, 'se_filterInput').send_keys("12")
    ...
    context.driver.find_element(By.CLASS_NAME, 'se_value').clear()

    context.driver.find_element(By.CLASS_NAME, 'se_value').send_keys("109")
...
@step('Then the rule can be used')
def test(context):
    # pesquisar operação
    context.driver.find_element(By.CLASS_NAME, 'se_filterInput').send_keys("109")
    ...
    context.utilities.wait_until_element_visible(element, 320)
